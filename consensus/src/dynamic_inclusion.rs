...
/// Dynamic inclusion threshold over time.
///
/// The acceptable proportion of chainx which must have candidates
...
impl DynamicInclusion {
    ...
    /// how many candidates are required at the beginning, and when an empty
    ...
    /// Returns the duration from `now` after which the amount of included candidates
