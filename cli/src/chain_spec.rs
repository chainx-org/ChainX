...
use xp_protocol::{NetworkType, PCX, PCX_DECIMALS, X_BTC, X_BTC_2};
...
fn build_genesis(
    ...
    dev::GenesisConfig {
        ...
        xpallet_mining_asset: Some(dev::XMiningAssetConfig {
            claim_restrictions: vec![(X_BTC, (10, DEV_DAYS * 7)), (X_BTC_2, (10, DEV_DAYS * 7))],
            mining_power_map: vec![(X_BTC, 400), (X_BTC_2, 400)],
        }),
