...
impl<T: frame_system::Trait> WeightInfo for SubstrateWeight<T> {
    ...
    fn set_asset_power() -> Weight {
        (5_370_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
}
...
impl WeightInfo for () {
    ...
    fn set_asset_power() -> Weight {
        (5_370_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
}
