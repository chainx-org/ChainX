...
NEW_TYPES = [
    ...
    "NominatorLedger", "NominatorProfile", "Order", "OrderExecutedInfo",
    "OrderId", "OrderInfo", "OrderType", "Price", "PriceFluctuation",
    "Selector", "Side", "StakingRequirement", "Token", "TradingHistoryIndex",
